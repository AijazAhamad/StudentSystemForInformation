...
namespace StudentSystemForInformationCRUD {
    ...
    public partial class StudentsDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentsRow AddStudentsRow(string RegNo, string Fname, string Lname, string Phone) {
...
namespace StudentSystemForInformationCRUD.StudentsDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Students] WHERE (([RegNo] = @Original_RegNo) AND ((@IsNull_Fname = 1 AND [Fname] IS NULL) OR ([Fname] = @Original_Fname)) AND ((@IsNull_Lname = 1 AND [Lname] IS NULL) OR ([Lname] = @Original_Lname)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([RegNo], [Fname], [Lname], [Phone]) VALUES (@RegNo," +
                " @Fname, @Lname, @Phone);\r\nSELECT RegNo, Fname, Lname, Phone FROM Students WHERE" +
                " (RegNo = @RegNo)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [RegNo] = @RegNo, [Fname] = @Fname, [Lname] = @Lname, [Phone] = @Phone WHERE (([RegNo] = @Original_RegNo) AND ((@IsNull_Fname = 1 AND [Fname] IS NULL) OR ([Fname] = @Original_Fname)) AND ((@IsNull_Lname = 1 AND [Lname] IS NULL) OR ([Lname] = @Original_Lname)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)));
SELECT RegNo, Fname, Lname, Phone FROM Students WHERE (RegNo = @RegNo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StudentSystemForInformationCRUD.Properties.Settings.Default.StudentsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT RegNo, Fname, Lname, Phone FROM dbo.Students";
        ...
        public virtual int Delete(string Original_RegNo, string Original_Fname, string Original_Lname, string Original_Phone) {
        ...
        public virtual int Insert(string RegNo, string Fname, string Lname, string Phone) {
            if ((RegNo == null)) {
        ...
        public virtual int Update(string RegNo, string Fname, string Lname, string Phone, string Original_RegNo, string Original_Fname, string Original_Lname, string Original_Phone) {
            if ((RegNo == null)) {
                throw new global::System.ArgumentNullException("RegNo");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Fname, string Lname, string Phone, string Original_RegNo, string Original_Fname, string Original_Lname, string Original_Phone) {
            return this.Update(Original_RegNo, Fname, Lname, Phone, Original_RegNo, Original_Fname, Original_Lname, Original_Phone);
        }
    }
